...
public class InsertTableTest {
    ...
    public static void main(String[] args) {
        ...
        try (Connection conn = DriverManager.getConnection(dbHost, dbUser, dbPass);
            ...
            preparedStatement.setString(1,"Мультиварка");
            preparedStatement.setBigDecimal(2, new BigDecimal(1499.20));
            preparedStatement.setInt(3,11);
            preparedStatement.setString(4,"Мультиварка с функцией MultiTouch");
            preparedStatement.setTimestamp(5,Timestamp.valueOf(LocalDateTime.now()));
